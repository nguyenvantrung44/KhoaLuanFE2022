...
const getSinhVienLopHocApi = async (idLopHoc) => { 
...
const getThongBaotSinhVienLopHocApi = async (idLopHoc) => { 
  return (await axiosClient())({
    method: 'GET',
...
const getThongBaotSinhVienLopHocPhanApi = async (idLopHoc) => { 
  return (await axiosClient())({
    method: 'GET',
...
const getSinhVienLopHocPhanApi = async (idLopHocPhan)=>{
  return (await axiosClient())({
    method: 'GET',
...
const getDonXinNghiHocApi = async (idGiangVien,idLopHocPhan)=>{
  return (await axiosClient())({
    method: 'GET',
