...
export default function BangDiem() {
  ...
  return (
    <div className="bangdiem">
      <h4 style={{ textAlign: 'center', marginBottom: '20px' }}>BẢNG ĐIỂM CÁC MÔN HỌC</h4>
      <table className="table table-bordered" >
        ...
        <tbody>
          ...
          <tr>
            ...
            <td colSpan="8" className="text-danger"><strong>{data ? Math.round(data.diemTongKet * 100) / 100 : ''}</strong></td>
          </tr> 
        </tbody>
      </table>
    </div>
