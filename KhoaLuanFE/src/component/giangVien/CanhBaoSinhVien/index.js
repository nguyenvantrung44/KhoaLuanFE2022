          ...
          <div className="modal-content">
            ...
            <div className="modal-body" style={{padding:'3%'}}>
              <div className="row">
                ...
                <div className="col-md-5 text-center" style={{border:'1px solid #e0e0eb', padding:'3%'}}>
                    <h6 style={{textAlign:'center'}}>TẠO CẢNH BÁO</h6>
                    <form className="form-card  justify-content-center" onSubmit={postCanhBao}>
