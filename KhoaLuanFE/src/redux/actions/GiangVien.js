...
export const atcGetSinhViensLopHoc = (idLop) => {
  return (dispatch) => {
    dispatch(displayLoading());
    getSinhVienLopHocApi(idLop)
      .then((res) => {
...
export const atcGetSinhViensLopHocPhan = (idLopHocPhan) => {
  return (dispatch) => {
    dispatch(displayLoading());
    getSinhVienLopHocPhanApi(idLopHocPhan)
      .then((res) => {
...
export const atcGetThongBaoSinhViensLopHoc = (idLop) => {
  return (dispatch) => {
    dispatch(displayLoading());
    getThongBaotSinhVienLopHocApi(idLop)
      .then((res) => {
...
export const atcChinhSuaBangDiem = (idlopHocPhan, idbangDiem, data) => {
  return (dispatch) => {
    ...
    putBangDiemSinhVienMonHocApi(idbangDiem, data)
      .then((res) => {
        dispatch(displayLoading());
        dispatch(atcGetSinhViensLopHocPhan(idlopHocPhan));
        dispatch(hideLoading());
        dispatch(
          displayNotify({ message: "Chỉnh sửa thành công!", type: "success" })
        );
...
export const atcGetNgayNghiSinhVien = (idSinhVienLopHocPhan) => {
  return (dispatch) => {
    getNgayNghiSinhVienApi(idSinhVienLopHocPhan)
      .then((res) => {
        console.log('idsvlhp', idSinhVienLopHocPhan)
...
export const atcGetThongBaoSinhViensLopHocPhan = (idLopHocPhan) => {
  return (dispatch) => {
    dispatch(displayLoading());
    getThongBaotSinhVienLopHocPhanApi(idLopHocPhan)
      .then((res) => {
...
export const atcGetDonXinNghiHoc = (idGiangVien, idLopHocPhan) => {
  return (dispatch) => {
    dispatch(displayLoading());
    getDonXinNghiHocApi(idGiangVien, idLopHocPhan)
      .then((res) => {
...
export const atcChapNhanDonXinNghiHoc = (
  ...
  return (dispatch) => {
    ...
    chapNhanDonXinNghiHocApi(idGiangVien, idDonXinNghiHoc)
      .then((res) => {
        dispatch(atcGetDonXinNghiHoc(idGiangVien, idLopHocPhan));
        dispatch(atcGetSinhViensLopHocPhan(idLopHocPhan));
